 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'RLFr pa&wE8tcyEBil2(c<b@~cA ,btJ#{xdZmLE8<-V>VKG_@)T_5hf|][S0-2X');
define('SECURE_AUTH_KEY',  '`LrzF-em%G/sCcGT3wj# HXxx[TETNS,Ep2&g/N8jDCJ-oK_&*q7uU9ic-^UOP(t');
define('LOGGED_IN_KEY',    '^oMWk!PTh6 ?9Z;:4}zF`$tYkk_|j!HDx>{UP(cbF0!HaVH)NidQ4/O.=)@&p<`1');
define('NONCE_KEY',        'p:Rr_}eKp|2rQIFYSk3:N4(kz||YbB@Qwfpz+v hX<2gzx8t?y%O9u/%~|H3^dm~');
define('AUTH_SALT',        '{^#xlyEhba|NOya<_%(4s3K-i@fX en&!j?ipT6JH`Jta=}oVY|(s%27yZX^o<LD');
define('SECURE_AUTH_SALT', '2%5osU*/jjC*]#f*QcotEs@Lj?&v;~99&U{XV{/UFh|IsL%4+JW9[zqJ!ngT{Ska');
define('LOGGED_IN_SALT',   'sav95KH8O,Rc@k$06*u9wR:E.iCOG}/6A)b_GyA]f};~B8@!=RHpqR:S#X{j8n2^');
define('NONCE_SALT',       '*!Fd^k(l/#+1P||$^K~$ rq85_BGmN3J/ma#&!/jZ21MW.I04W,9!?5ix<F#*a|A');
